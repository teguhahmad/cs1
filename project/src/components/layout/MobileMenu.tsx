...
import { X, Home, Users, DoorClosed, CreditCard, ClipboardList, BarChart, Settings, Bell, LogOut, Building2 } from 'lucide-react';
...
const MobileMenu: React.FC<MobileMenuProps> = ({ activeItem, onItemClick, onClose }) => {
  ...
  const menuItems = [
    ...
    { id: 'properties', label: 'Properti', icon: <Building2 size={20} /> },
